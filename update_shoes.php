<?php
    ...
    if(isset($_POST['submit'])){
            ...
            $sql = "UPDATE footwear SET Price =:price, ShoeSize =:size, Quantity =:quantity WHERE ProductID =:pid";
    ...
    <div id="formback">
        ...
        <form style="background-color: rgb(255, 192, 199); border-radius: 10px;padding-top: 10px;" action="#" method="post">
          <div style="margin-left: 50px;">
            ...
            <label for="material">Sole_Material:</label>
            <b id="material" name="material"><?php echo($row->Sole_Material); ?></b><br>
            <label for="type">ShoeType:</label>
            <b id="type" name="type"><?php echo($row->ShoeType); ?></b><br>
            ...
            <input id="price" name="price" type="number" value="<?php echo($row->Price); ?>" placeholder="" class="input_field"><br>
            <label for="size" style="margin-right: 38px;">ShoeSizes:</label>
            <input id="size" name="size" style="right: 38px;position: relative;" type="text" value="<?php echo($row->ShoeSize); ?>" placeholder="" class="input_field"><br>   
            <label for="quantity" style="margin-right: 28px;">Quantity:</label>
            <input id="quantity" name="quantity" style="right: 30px;position: relative;" type="number" value="<?php echo($row->Quantity); ?>" placeholder="" class="input_field"><br>           
