...
<body style="margin: 0px;" id="back3">
    ...
    <div style=" text-align:center;width: 50%; margin: auto;background-color:#00004f;color:white ;border-radius: 25px; margin-top: 100px; border: 2px solid white;">
            ...
            <?php 
                ...
                ?>
                    <div class="errorWrap" style="color: white;">
                        <strong>ERROR</strong>: <?php echo htmlentities($error1); ?>
                    </div>
                <?php 
                } 
                if($error){
        ...
        <h4>Deleting Your account will remove all your data permanantly</h4>
        <h4>Are you sure you want to delete your account?</h4>
        <form action="#" method="post" >
            <input class="input_field1" type="password" id="pwd" name="pwd" placeholder="Enter password" required><br>
            <input id="user" type="checkbox" onclick="showpass()">Show Password<br><br>
            <button type="reset" id="cancel" name="cancel"><a href="login_data.php" style="color: white;">Cancel</a></button>
